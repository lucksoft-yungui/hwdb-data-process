...
def generate_dataset(words_file, char_images, output_dir, num_samples, label_file, max_length, min_spacing, max_spacing):
    ...
    with open(label_file_path, 'w', encoding='utf-8') as f:
        for i in range(num_samples):
            ...
            img_path = os.path.join(output_dir, "imgs", f"{i}.png")
            cv2.imwrite(img_path, blank_image)
            
            f.write(f"{i}.png {word}\n")
...
if __name__ == "__main__":
    ...
    generate_dataset("data/words.txt", test_images, "/Users/peiyandong/Documents/code/ai/train-data/hwdb/single/data", 500, "hwdb_val.txt", 7, 0, 10)
